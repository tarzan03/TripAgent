...
"""
    ...
    response = llm.invoke(
        [
            SystemMessage(
                content="you are an expert travel planner with 20 years in this field"
            ),
...
- Also please add image urls for the hotels/cities/sports/places/activities suggested .
