...
CITY_MAIN_AIRPORT = {
    ...
    "sardar vallabhbhai patel airport": "AMD",
    "goa airport": "GOI",
    "dabolim airport": "GOI",
    "dabolim": "GOI",
    "manohar airport": "GOX",
...
COUNTRY_MAIN_AIRPORT = {
    ...
    "IR": "IKA",  # Iran - Tehran Imam Khomeini
    "IQ": "BGW",  # Iraq - Baghdad
    ...
    "LU": "LUX",  # Luxembourg
    "MT": "MLA",  # Malta
    "MD": "KIV",  # Moldova - Chisinau
    "MC": "NCE",  # Monaco - Nice (nearest major airport)
    ...
    "SM": "RMI",  # San Marino - Rimini (nearest major airport)
    ...
    "VA": "FCO",  # Vatican City - Rome Fiumicino
    # North America
    ...
    "GY": "GEO",  # Guyana - Georgetown
    "PY": "ASU",  # Paraguay - Asuncion
    "PE": "LIM",  # Peru - Lima
    "SR": "PBM",  # Suriname - Paramaribo
    ...
    "CM": "DLA",  # Cameroon - Douala
    "CV": "RAI",  # Cabo Verde - Praia
    "CF": "BGF",  # Central African Republic
    "TD": "NDJ",  # Chad - N'Djamena
    "KM": "HAH",  # Comoros
    "CG": "BZV",  # Republic of Congo - Brazzaville
    "CD": "FIH",  # DR Congo - Kinshasa
    "CI": "ABJ",  # Côte d'Ivoire - Abidjan
    "DJ": "JIB",  # Djibouti
    "EG": "CAI",  # Egypt - Cairo
